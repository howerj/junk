...
/* The reference paper recomends using the first 256 primes, starting from 2,
 * modulo 256, for the S-Box. These are not the recommended S-Box values.
 *
 * See:
 *   Yuval G. (1997) Reinventing the travois: Encryption/MAC in 30 ROM bytes. 
 *   In: Biham E. (eds) Fast Software Encryption. FSE 1997. 
 *   Lecture Notes in Computer Science, vol 1267. Springer, Berlin, Heidelberg
 * */
