...
static char *trans[] = {
        ...
        "yes", "Tell me more about that in detail.",
        "fuck", "Don't be so rude again!",
        "shit", "Can we keep this civil, please?",
        "you", "Let's not talk about me. How do you feel?",
        "think", "Why do you think that?",
        "hate", "Hate is a strong word, do you think your hate is healthy?",
        "what", "Why do you ask?",
        "want", "Why do you want that?",
        "need", "We all need many things -- is this a special need, or a want?",
        ...
        "never", "Negativity is a drain, please, try to be positive.",
        "unhappy", "Why are you unhappy?",
        "beautiful", "I'm sure you like them, don't you?",
        "like", "Why do you like that?",
        "love", "Love is a powerful force, try to love more.",
        ""
};
